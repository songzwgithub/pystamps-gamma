...
export PYSTAMPS_STAGE6_GRID_IFG_BATCH="${PYSTAMPS_STAGE6_GRID_IFG_BATCH:-4}"
export PYSTAMPS_STAGE6_GRID_WINDOW_BATCH="${PYSTAMPS_STAGE6_GRID_WINDOW_BATCH:-32}"
export PYSTAMPS_STAGE6_GRID_FFT_WORKERS="${PYSTAMPS_STAGE6_GRID_FFT_WORKERS:-16}"
export PYSTAMPS_STAGE6_GRID_RESUME="${PYSTAMPS_STAGE6_GRID_RESUME:-1}"
...
echo "============================================================"
echo "StaMPS-compatible SBAS Stage 6 — GRID batch v2"
echo "Dataset          : $DATASET"
echo "GRID IFG batch   : $PYSTAMPS_STAGE6_GRID_IFG_BATCH"
echo "GRID window batch: $PYSTAMPS_STAGE6_GRID_WINDOW_BATCH"
echo "GRID FFT workers : $PYSTAMPS_STAGE6_GRID_FFT_WORKERS"
...
exec python -m pystamps.pipeline.stage6_sbas \
    --dataset "$DATASET" \
    --io-workers 1 \
    "$@"
